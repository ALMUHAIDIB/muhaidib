...
class saleorderLineInherit(models.Model):
    ...
    is_has_group_price = fields.Boolean(default=lambda self:self.check_user_has_group_default(),compute='check_user_has_group')
...
class saleorderInherit(models.Model):
    ...
    is_has_group_sale_person = fields.Boolean(default=lambda self:self.check_user_has_group_default(),compute='check_user_has_group')

    team_id = fields.Many2one('crm.team', 'Sales Team',related='user_id.x_team_id',store=True,change_default=True, default=False,
                              oldname='section_id')
